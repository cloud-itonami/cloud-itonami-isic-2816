...
`cloud-itonami-isic-2816` is an OSS open-business blueprint for industrial lifting
and material-handling equipment manufacturing enablement, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Lifting Equipment Governor remains independent of the advisor.
