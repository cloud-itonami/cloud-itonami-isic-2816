# Operator Quickstart — Manufacture of Lifting and Handling Equipment

Shortest path from clone to a verified local dry-run for **ISIC 2816** (`cloud-itonami-isic-2816`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2816.git
cd cloud-itonami-isic-2816
```
...
- Blueprint governor key: `liftingequip-governor`
- Likely source path: `liftingequip.governor.cljc`
